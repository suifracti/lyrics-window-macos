...
LRCLIB_SOURCES=(
  ...
  "$ROOT_DIR/SpotifyLyrics/Lyrics/LocalLyricsProvider.swift"
  "$ROOT_DIR/SpotifyLyrics/Lyrics/LRCLIBLyricsProvider.swift"
  "$ROOT_DIR/SpotifyLyrics/Lyrics/AMLLLyricsProvider.swift"
...
PLAYBACK_SOURCES=(
  ...
  "$ROOT_DIR/SpotifyLyrics/Design/PresentationCatalog.swift"
  "$ROOT_DIR/SpotifyLyrics/Design/PresentationSelectionStore.swift"
  "$ROOT_DIR/SpotifyLyrics/Design/SettingsCenterPresentation.swift"
  ...
  "$ROOT_DIR/SpotifyLyrics/Lyrics/AIReadingCandidateService.swift"
  ...
  "$ROOT_DIR/SpotifyLyrics/Design/LyricsDesignTokens.swift"
