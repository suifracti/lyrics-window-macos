...
swiftc -parse-as-library \
  ...
  "$ROOT_DIR/Tests/track_identity_v4_persistence_contract.swift" \
  -o "$TMP_DIR/track-identity-v4-persistence-contract"

"$TMP_DIR/track-identity-v4-persistence-contract"
